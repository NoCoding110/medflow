      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        ...
        <div className="mt-4 md:mt-0 flex items-center gap-4">
          <div className="bg-purple-100 text-purple-700 py-1 px-3 rounded-full text-sm flex items-center">
            <Clock className="mr-1 h-4 w-4" /> {new Date().toLocaleDateString()}
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription>8 scheduled for today</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">10:00 AM - Follow-up</p>
                </div>
                <div className="bg-blue-100 text-blue-700 px-2 py-1 rounded text-xs">In 30 min</div>
              </div>
              <div className="flex justify-between items-center">
                <div>
                  <p className="font-medium">Amy Johnson</p>
                  <p className="text-sm text-muted-foreground">11:15 AM - New Patient</p>
                </div>
                <div className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs">In 1h 45m</div>
              </div>
              <div className="flex justify-between items-center">
                <div>
                  <p className="font-medium">Robert Davis</p>
                  <p className="text-sm text-muted-foreground">1:30 PM - Consultation</p>
                </div>
                <div className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs">In 4h</div>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="flex flex-col space-y-4">
              <div className="grid grid-cols-7 gap-2">
                ...
                {[...Array(7)].map((_, i) => (
                  <div key={i} className="aspect-square border rounded-md flex flex-col items-center justify-center p-1">
                    <p className="text-sm font-semibold">{27 + i}</p>
                    <p className="text-xs text-muted-foreground">{i === 0 ? '8' : i === 1 ? '6' : i === 2 ? '5' : i < 5 ? '4' : '0'}</p>
                  </div>
                ))}
              </div>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm">Regular Appointments</p>
                </div>
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded-full bg-purple-500"></div>
                  <p className="text-sm">Telehealth Sessions</p>
                </div>
                <div className="flex items-center gap-2">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <p>Review lab results for Thomas Moore</p>
              </div>
              <div className="flex items-center gap-3">
                <input type="checkbox" className="rounded text-purple-600 focus:ring-purple-500" />
                <p>Update treatment plan for Jessica Brown</p>
              </div>
              <div className="flex items-center gap-3">
                <input type="checkbox" className="rounded text-purple-600 focus:ring-purple-500" />
                <p>Submit insurance claim for William Davis</p>
              </div>
              <div className="flex items-center gap-3">
                <input type="checkbox" className="rounded text-purple-600 focus:ring-purple-500" />
                <p>Call pharmacy about prescription error</p>
              </div>
              <div className="flex items-center gap-3">
                <input type="checkbox" className="rounded text-purple-600 focus:ring-purple-500" />
                <p>Complete CME course (due Friday)</p>
              </div>
            </div>
          </CardContent>
        </Card>
